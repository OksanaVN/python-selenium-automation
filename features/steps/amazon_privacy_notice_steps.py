...
def verify_amazon_privacy_notice_page(context):
    context.driver.wait.until(EC.url_contains("ttps://www.amazon.com/gp/help/customer/display.html?nodeId=GX7NJQ4ZB8MHFRNJ"))


@then('User can close new window and switch back to original')
def user_close_window_and_returns_to_original(context):
